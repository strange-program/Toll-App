...
- Για τα API endpoints μπορείτε να συμβουλευθείτε
- Το cli 
...
## Σύνδεσμοι
- [Προδιαγραφές REST API](docs/api.md)
- [Εγχειρίδιο CLI](docs/cli.md)

---
 Απόστολος Σκότης, Φιλοθέη Λιναρδάτου, Δημήτρης Δημητρακόπουλος, Εμμανουήλ Ρεΐζης
